...
subplot(2,2,1)
plot([0:10:360], histogram_rot_FEAST);
...
title('FEAST Histogram')  
subplot(2,2,3)
plot([0:10:360], histogram_rot_SURF);
set(gca,'xtick',[0:10:360]);
